...
export function createTransportAdapter(worker, transport, hooks = {}) {
  ...
  return {
    ...
    sendBatch(batch) {
      // ⚡ Bolt: Replace Array.prototype.forEach() with a standard for loop
      // to prevent anonymous function allocation, reducing Garbage Collection (GC) overhead
      // during high-frequency packet sending.
